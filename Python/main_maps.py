...
functions.handleMaps(data_adcmap, adc_map, data_adcmap24, adc_map_24, data_mask, "ADCmap")
functions.handleMaps(data_admap, ad_map, data_admap24, ad_map_24, data_mask, "ADmap")
functions.handleMaps(data_clmap, cl_map, data_clmap24, cl_map_24, data_mask, "CLmap")
functions.handleMaps(data_cpmap, cp_map, data_cpmap24, cp_map_24, data_mask, "CPmap")
functions.handleMaps(data_csmap, cs_map, data_csmap24, cs_map_24, data_mask, "CSmap")
functions.handleMaps(data_famap[:,:,:,0], fa_map, data_famap24[:,:,:,0], fa_map_24, data_mask, "FAmap_Red")
functions.handleMaps(data_famap[:,:,:,1], fa_map, data_famap24[:,:,:,1], fa_map_24, data_mask, "FAmap_Green")
functions.handleMaps(data_famap[:,:,:,2], fa_map, data_famap24[:,:,:,2], fa_map_24, data_mask, "FAmap_Blue")
functions.handleMaps(data_rdmap, rd_map, data_rdmap24, rd_map_24, data_mask, "RDmap")		
